package dev.alphaserpentis.examples.coffeecore.custom;
...
import dev.alphaserpentis.examples.coffeecore.custom.deserializer.CustomEntityDataDeserializer;
import dev.alphaserpentis.examples.coffeecore.custom.handler.CustomDataHandler;
...
public class CustomServerDataExample {
    public static void main(String[] args) throws IOException {
        ...
        BotSettings botSettings = new BotSettings(
                ...
                Boolean.parseBoolean(dotenv.get("SHOW_STACK_TRACE")),
                null
        );
