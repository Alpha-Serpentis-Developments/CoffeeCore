package dev.alphaserpentis.examples.coffeecore.kotlin.dev.alphaserpentis.examples.coffeecore.hello
...
class HelloCommandButton: ButtonCommand<MessageEmbed, SlashCommandInteractionEvent>(
    ...
    override fun addButtonsToMessage(event: SlashCommandInteractionEvent): Collection<Button> {
